                ...
                row = new ActionRowBuilder().addComponents(
                    new StringSelectMenuBuilder()
                        ...
                        .addOptions([
                            {
                                label: 'R3d Eng1ne',
                                emoji: { id: '1389181300912427159', name: 'red' },
                                description: 'See price and info for R3d Eng1ne.',
                                value: 'red_engine',
                            },
                            {
                                label: 'K3yser',
                                emoji: { id: '1382655865521311825', name: 'keyser' },
                                description: 'See price and info for K3yser.',
                                value: 'keyser',
                            },
                            {
                                label: 'V3ntiq',
                                emoji: { id: '1398725075334729840', name: 'V_' },
                                description: 'See price and info for V3ntiq.',
                                value: 'ventiq',
                            },
                            {
                                label: 'Un1core',
                                emoji: { id: '1382655674202198028', name: 'unicloud' },
                                description: 'See price and info for Un1core.',
                                value: 'unicore',
                            },
                            {
                                label: 'Hx S0ftware',
                                emoji: { id: '1382653761088131152', name: 'hx' },
                                description: 'See price and info for Hx S0ftware.',
                                value: 'hx',
                            },
                            {
                                label: 'Ti4go',
                                emoji: { id: '1384888331866734764', name: 'tiagomodz_logo' },
                                description: 'See price and info for Ti4go.',
                                value: 'tiago',
                            },
                            {
                                label: 'M4cho',
                                emoji: { id: '1382657610355966063', name: 'MachoLogo' },
                                description: 'See price and info for M4cho.',
                                value: 'macho',
                            }
                        ])
                );
                ...
                row = new ActionRowBuilder().addComponents(
                    new StringSelectMenuBuilder()
                        ...
                        .addOptions([
                            ...
                            {
                                label: 'Silent',
                                emoji: { id: '1395058293432516658', name: 'silent' },
                                description: 'See price and info for Silent.',
                                value: 'silent',
                            }
                        ])
                );
                        ...
                        .addOptions([
                            {
                                ...
                                description: 'See price and info for Fiv3M R3ady.',
                                value: 'fivem_ready',
                            },
                            {
                                label: 'St34m',
                                emoji: { id: '1382653631488200754', name: 'Steam' },
                                description: 'See price and info for St34m.',
                                value: 'steam',
                            },
                            {
                                label: 'D1sc0rd',
                                emoji: { id: '1382653651214012477', name: 'DISCORD' },
                                description: 'See price and info for D1sc0rd.',
                                value: 'discord',
                            },
                            {
                                label: '!P V4nish',
                                emoji: { id: '1382653594716737687', name: 'ipvanish' },
                                description: 'See price and info for !P V4nish.',
                                value: 'ip-vanish',
                            }
                        ])
                );
                        ...
                        .addOptions([
                            {
                                label: 'Fiv3M Bundle',
                                emoji: { id: '1382655702606151680', name: 'Rockstar' },
                                description: 'See price and info for Fiv3M Bundle.',
                                value: 'fivem_bundle',
                            },
                            {
                                label: 'D1sc0rd Bundle',
                                emoji: { id: '1382653651214012477', name: 'DISCORD' },
                                description: 'See price and info for D1sc0rd Bundle.',
                    ...
                    new StringSelectMenuBuilder()
                        ...
                        .addOptions([
                            ...
                            },
                            {
                                label: 'Ventiq',
                                emoji: { id: '1398725075334729840', name: 'V_' },
                                description: 'See price and info for Ventiq.',
