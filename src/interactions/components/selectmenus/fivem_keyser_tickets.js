...
module.exports = {
    async execute(interaction) {
        ...
        const modal = new ModalBuilder()
            ...
            .setTitle('Keyser FiveM - Ticket');

        let licenseField, paymentField;

        switch (selectedValue) {
            case 'fivem_keyser_1day':
                licenseField = new TextInputBuilder()
                    .setCustomId('license')
                    .setLabel('Type?')
                    .setStyle(TextInputStyle.Short)
                    .setPlaceholder('Keyser FiveM 1 Day')
                    .setValue('1 Day')
                    .setRequired(true);
                break;
            case 'fivem_keyser_7days':
                licenseField = new TextInputBuilder()
                    .setCustomId('license')
                    .setLabel('Type?')
                    .setStyle(TextInputStyle.Short)
                    .setPlaceholder('Keyser FiveM 7 Days')
                    .setValue('7 Days')
                    .setRequired(true);
                break;
            case 'fivem_keyser_month':
                licenseField = new TextInputBuilder()
                    .setCustomId('license')
                    .setLabel('Type?')
                    .setStyle(TextInputStyle.Short)
                    .setPlaceholder('Keyser FiveM 1 Month')
                    .setValue('1 Month')
                    .setRequired(true);
                break;
            case 'fivem_keyser_lifetime':
                licenseField = new TextInputBuilder()
                    .setCustomId('license')
                    .setLabel('Type?')
                    .setStyle(TextInputStyle.Short)
                    .setPlaceholder('Keyser FiveM Lifetime')
                    .setValue('Lifetime')
                    .setRequired(true);
                break;
        }
